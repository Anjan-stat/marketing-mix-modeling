...
$$\hat{\boldsymbol{\beta}} = \underset{\boldsymbol{\beta} \geq 0}{\arg\min} \left \{ \lVert \mathbf{y} - \mathbf{X}^{\star} \boldsymbol{\beta} \rVert_2^2 + \lambda_{\text{ridge}} \lVert \boldsymbol{\beta} \rVert_2^2 \right \}$$
